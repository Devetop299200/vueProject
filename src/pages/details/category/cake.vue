            ...
            <div class="sales-board-form">
                <div class="sales-board-line">
                    ...
                    <div class="sales-board-line-right">
                        <counter @on-change="getInfo" :max="maxCounter" :min="minCounter"></counter>    
                    </div>
                </div>        
                ...
                <div class="sales-board-line">
                    ...
                    <div class="sales-board-line-right"> 
                        <caketype :chooses="chooseData"></caketype>
                    </div>
                </div>
                ...
                <div class="sales-board-line">
                    ...
                    <div class="sales-board-line-right">
                      <a href="javascript:;" class="button" @click="buy">立即购买</a>
                    </div>
                </div>
            </div>
